...
class FuryRuneword extends Runeword {
    constructor() {
        ...
        this.properties = [
            new Property('Enhanced Damage', new PropertyValueVaries(209, 269, '%')),
...
class InsightRuneword extends Runeword {
    constructor() {
        ...
        this.bases = [Bases.staves, Bases.polearms, Bases.spears];
...
class VenomRuneword extends Runeword { // todo: other dot dmg
    constructor() {
        ...
        this.properties = [
            ...
            new Property('Enemy Poison Resistance', new PropertyValueVaries(10, 20, '%'), false),
            new Property('Poison Damage', new PropertyValueDuration(198,6))
        ]
...
class WhiteRuneword extends Runeword {
    constructor() {
        ...
        this.properties = [
            ...
            new Property('Bone Armor', new PropertyValueVaries(1, 3), true, 'Necromancer'),
...
class BreathOfTheDyingRuneword extends Runeword {
    constructor() {
        ...
        this.properties = [
            ...
            new Property('Life Stolen per Hit', new PropertyValueVaries(7,9,'%')),
            new Property('Prevent Monster Heal', false),
...
class ChaosRuneword extends Runeword {
    constructor() {
        ...
        this.properties = [
            new PropertyCastChance( new Skill('Frozen Orb', 21), new PropertyValue(9, '%'), 'strike'),
            new PropertyCastChance( new Skill('Charged Bolt', 29), new PropertyValue(11, '%'), 'strike'),
            ...
            new Property('Repairs Durability', new PropertyValueDuration(1, 12)),
        ]
...
class CrescentMoonRuneword extends Runeword {
    constructor() {
        ...
        this.bases = [Bases.axes, Bases.swords, Bases.polearms, Bases.spears];
